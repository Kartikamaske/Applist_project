     ...
     foreach($detailblog as $rw=>$value){
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                ...
                <div class="d-flex mt-3" style="justify-content:space-between;font-size:16px;">
                    <div>
                        <img src="<?= base_url();?>Assets/imgs/popadmin.jpg" alt="" style="height:50px; border-radius: 50%;"><span style="font-size:16px;">By,'.$value->blog_by_name.'</span>
                    </div>

                    <div>
                        <p class="mt-4" style="font-size:16px;"><i class="fa-regular fa-clock">'.$value->publishdate.'</i></p>
                    </div>
                </div>
                <hr style="border-top: 1px solid black;"> 

                <p>'.$value->blogdescription.'</p><br>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                    ...
                    <div class="row">
                        ...
                        <input type="text"  placeholder="Enter Your email" class="form-control" id="email" name="email" value="">
                        </div>
    
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <input type="text"  placeholder="Subject" class="form-control" id="subject" name="subject" value="">
                        </div>
                    </div>
    
                    <textarea name="message" id="message" cols="30" rows="10" placeholder="your message" class="form-control" value=""></textarea><br><br>
