...
<div class="modal" id="myModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <form role="form" id="Form" enctype="multipart/form-data" action="" method="post" class="p-2">
      ...
      <input type="hidden" class="form-control" id="viewdemoid" placeholder="" name="viewdemoid" value="<?php if(!empty($dataa[0]->viewdemoid)){echo $dataa[0]->viewdemoid;}?>">
        ...
        <div class="modal-body">
            ...
            <br>
            <button type="button" class="btn btn-success" style="float:right;background-color:#2f256d;color:white;"id="btn_save" class="btn_save">Get Demo</button>
        </div>
     </form>
